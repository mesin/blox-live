...
module.exports = {
  setupEnv: async () => {
    ...
    const output = await ssh.execCommand('mkdir blox-live && cd blox-live && curl https://raw.githubusercontent.com/prysmaticlabs/prysm/master/prysm.sh --output prysm.sh && chmod +x prysm.sh  && ls -lah', {});
