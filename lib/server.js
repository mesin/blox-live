  ...
  setupEnv: async () => {
    ...
    if (!dockerImageIsUp) {
      ...
      */
      ...
      output = await ssh.execCommand('curl -L "https://raw.githubusercontent.com/bloxapp/vault-plugin-secrets-eth2.0/v0.0.8/docker-compose.yml" -o docker-compose.yml && docker-compose up -d vault-image', {});
      await delay(30000);
